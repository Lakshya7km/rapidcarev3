            ...
            {!canUpdate ? (
                ...
                <div style={{ width: '100%', maxWidth: 420 }}>
                    ...
                    {!scanNext ? (
                        ...
                        <div style={{ marginTop: 16, background: 'white', borderRadius: 16, padding: 16, boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                                <span style={{ fontSize: 13, fontWeight: 700, color: '#64748b' }}>Scan QR Code</span>
